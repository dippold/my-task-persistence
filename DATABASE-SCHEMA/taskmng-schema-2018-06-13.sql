...
CREATE TABLE `user` (
  ...
  `email` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_unique_01` (`companyId`,`name`),
  UNIQUE KEY `user_unique_02` (`companyId`,`name`,`email`),
  UNIQUE KEY `user_unique_03` (`companyId`,`email`),
...
-- Dump completed on 2018-06-13 17:14:24
