...
INSERT INTO `backlogitem` VALUES (00000000001,00000000001,00000000002,00000003401,00000006252,'2018-01-01','Indicador FIPE Neogrid','',NULL,12,0,NULL,NULL,NULL,NULL,'','',''),(00000000001,00000002255,00000000004,00000003401,00000006352,'2018-06-01','Consultoria Dataquality','Contratação de consultoria em processos de qualidade de dados para o projeto.','Consultoria externa em dataquality.',2000,60,60000,'2018-07-02','2018-07-27','2018-08-03','','',''),(00000000001,00000002255,00000000008,00000005152,00000009402,'2018-06-01','Padronização Unidades de Medida','Padronização de unidades de medidas de todos os produtos com sistema internacional.','Analista de qualidade de dados',100,60,NULL,'2018-07-31','2018-06-29',NULL,'Iniciou na Sprint 2018-6.\r\nPlanejada na Sprint 2018-7.','Varejo trabalha com unidades e a industria trabalha com vários tipos de embalagens','Aprovado na comissão de produto.');
...
) ENGINE=InnoDB AUTO_INCREMENT=10702 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `project` (
  ...
  `plannedDate` varchar(45) DEFAULT NULL,
...
INSERT INTO `sequence` VALUES ('SEQ_GEN',10750);
...
-- Dump completed on 2018-07-09 18:51:38
